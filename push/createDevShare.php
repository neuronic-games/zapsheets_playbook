<?php
/**
 * Create (or refresh) a collaborator share token for a DevBoard game.
 * Stores shares/dev-collab/{token}.json → { sheet_id, game, sharer }
...
$viewUrl = $scheme . '://' . $host . $appRoot . '/devboard/share/' . $token;

// GET: just check whether the token file exists
$viewsDir = realpath(__DIR__ . '/..') . DIRECTORY_SEPARATOR . 'shares' . DIRECTORY_SEPARATOR . 'dev-collab';
if ($isGet) {
