...
if (!file_exists($bggScript)) {
    ...
    if ($out === '') {
        ...
        foreach (explode("\n", $out) as $line) {
            ...
            elseif (str_starts_with($line, 'SKIP'))   echo "  · " . $line . "\n";
...
// ── Step 6: Cache media files (images, videos) ───────────────────────────────
